...
2. Trace the actual code (`android/app/src/main/java/com/example/gametemplate/`) to confirm the docs match reality; flag drift explicitly rather than silently trusting either source.
