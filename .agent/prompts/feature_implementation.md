...
2. Check `moon/roadmaps/gameplay.md` (or the relevant roadmap file) and `docs/adr/` for prior decisions that constrain the design.
...
5. Update `docs/ARCHITECTURE.md` and `moon/CHANGELOG.md` if the feature changes module boundaries or ships user-visible behavior.
