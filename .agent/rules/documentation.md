...
- Keep `docs/moon/CHANGELOG.md` updated for anything that changes the public surface (a new screen, a new save-format version, a new Play Store release track).
