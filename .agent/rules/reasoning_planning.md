...
- Before implementing a new gameplay system, check `moon/roadmaps/gameplay.md` and `docs/adr/` for existing decisions that constrain the design — don't re-litigate a settled ADR without a new one that supersedes it.
