...
```bash
just apk                # ./android/gradlew assembleDebug
just unit-test           # ./android/gradlew testDebugUnitTest
just test-instrumented  # ./android/gradlew connectedDebugAndroidTest (needs a device/emulator)
