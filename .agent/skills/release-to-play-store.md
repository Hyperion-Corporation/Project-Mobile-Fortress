...
For the iOS equivalent (App Store Connect), see [`moon/roadmaps/ios.md`](../../moon/roadmaps/ios.md) — signing/export automation is not built yet; `just ios-archive` produces an unsigned `.xcarchive` as a starting point.
