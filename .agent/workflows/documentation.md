...
1. Identify what changed: module boundary → `docs/ARCHITECTURE.md`; a hard-to-reverse decision → new `docs/adr/NNNN-*.md`; shipped work → `moon/CHANGELOG.md`; planned work → the relevant `moon/roadmaps/*.md`.
