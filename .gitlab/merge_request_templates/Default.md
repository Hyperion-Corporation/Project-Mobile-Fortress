...
- [ ] If this changes shared behavior (state machine, level schema), `game/src/game-state-machine.md` or `game/src/level-schema.json` updated and both platforms kept in sync.
