...
| Rust core micro-benchmarks | `criterion` (planned, once the crate exists) | ECS iteration throughput, Flow Field recompute cost, `rkyv` (de)serialization cost | [`docs/moon/roadmaps/shared_core.md`](moon/roadmaps/shared_core.md), [`docs/moon/roadmaps/performance.md`](moon/roadmaps/performance.md) P2/P5 |
