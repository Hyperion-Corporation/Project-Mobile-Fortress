...
This is a two-client repository: a Kotlin Android app (`android/`) and a Swift iOS app (`ios/`), sharing raw assets and a documented spec under `game/` (migrating to a compiled C++ shared core — see [`moon/roadmaps/shared_core.md`](moon/roadmaps/shared_core.md)).
