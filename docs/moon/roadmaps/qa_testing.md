...
| Q2 | CI matrices (update for Godot export + Android 13+ / iOS 17+) | M | 📋 Pending |
| Q3 | C++ core unit + property tests (pathing, ECS ordering) | L | 📋 Pending |
| Q4 | Regression harness: fixed seed → consistent outcomes (soft determinism; not lockstep-hard) | L | 📋 Pending |
