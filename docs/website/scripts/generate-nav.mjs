...
const EXTRA_SECTIONS = [
  ...
  },
  {
    ...
    children: [
      { title: "Docker", source: "infra/global/docker/README.md" },
      { title: "Kubernetes", source: "infra/global/k8s/README.md" },
      { title: "Helm", source: "infra/global/helm/README.md" },
      { title: "Terraform", source: "infra/global/terraform/README.md" },
      { title: "Ansible", source: "infra/global/ansible/README.md" },
    ],
  },
];
...
function walk(node) {
  ...
  if (typeof value === "string") {
    ...
    return { title, kind: "md", path: slugify(value), source: "docs/" + value };
  }
