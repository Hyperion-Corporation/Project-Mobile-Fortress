...
- Build context is the **repository root** — the Dockerfile expects a `backend/` (or similar) source directory that does not exist yet. Add it before building, or delete `infra/global/docker/` if you never need a backend.
