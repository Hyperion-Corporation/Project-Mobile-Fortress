...
| # | Item | Effort | Status |
| --- | --- | --- | --- |
| A1 | Wave Function Collapse (WFC) siege-map generation: tile-based castle-grounds layouts with valid path/wall adjacency constraints | L | 📋 Pending |
| A2 | MILP-augmented WFC to guarantee global solvability (a traversable enemy-spawn-to-keep path always exists) | L | 📋 Pending |
