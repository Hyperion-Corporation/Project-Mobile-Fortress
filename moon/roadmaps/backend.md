...
| B7 | Leaderboards REST API (clan rankings, individual castle-defense scores) | L | 📋 Pending |
...
| B10 | Clan/territory persistent-world-map service (owns the 4X-lite meta-map state) | XL | 📋 Pending |
