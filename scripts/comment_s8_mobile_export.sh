...
- \`core/export_presets.cfg\`: **Android Debug** (Gradle, minSdk 33, target 35, package \`com.acfharbinger.mobilefortress\`) + **iOS** (min 17.0)
- Docs: \`core/EXPORT_MOBILE.md\`
...
- **Verified:** Android debug APK export on Linux (~159MB under \`core/exports/android/\`, gitignored)
...
gh issue comment 63 --body "IOS3/export: iOS preset min 17.0 in \`core/export_presets.cfg\`. GDExtension path \`ios.arm64\` declared. Actual dylib + Xcode export still needs macOS collaborator."
